  ...
  return (
    <article className="prose prose-slate max-w-none text-slate-700 space-y-8">
      ...
      <p className="text-sm text-slate-500">
        <strong>Parties:</strong> Ionverge LLC (&ldquo;Company&rdquo;) and the undersigned individual (&ldquo;Recipient&rdquo;)
        <br />
      ...
      <section>
        ...
        <p>
          ...
          shall remain in force for <strong>three (3) years</strong> after termination of the business relationship.
        </p>
        <p className="mt-2">
          <strong>CRITICAL PRIVACY UNDERTAKING:</strong> Notwithstanding anything to the contrary, the
          Recipient&apos;s confidentiality obligations with respect to Patient Data,
          Personal Identifiable Information (PII), and Protected Health Information (PHI)
          shall <strong>SURVIVE the termination of this Agreement INDEFINITELY</strong>.
        </p>
      </section>
